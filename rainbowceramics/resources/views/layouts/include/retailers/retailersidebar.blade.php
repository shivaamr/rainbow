<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
    ...
    <li class="nav-item {{Request::is('admin/category') ? 'active':''}} ">
        ...
        <div id="collapseTwo" class="collapse {{Request::is('retailers/category') ? 'show':''}}" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">


                <a class="collapse-item" href="{{ url('retailers/category')}}">View Category</a>
            </div>
        </div>
    </li>
